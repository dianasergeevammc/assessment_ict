...
to_write = ["the student calculation would be here if I knew how to set up dictionaries. I am a stubborn person, \n"
            "made my own program and shall suffer the consequences. You, middle schooler should've known better than \n"
            "depending on a calculator program to write it all for you, because if I were using the calculator, \n"
            "I would've written answers as we go. Count this as a word of wisdom from a programming class failee. \n"]
